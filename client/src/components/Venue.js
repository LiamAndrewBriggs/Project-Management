                ...
                <div id="singleBody">
                    <form onSubmit={this.editVenue.bind(this)}>
                        ...
                        <div className="row">
                            <div id="editinfo">
                                    <label> Name: </label>
                                    <input id="inputs" ref= "name" type="text" defaultValue={this.state.name} />
                                    <br/>
                                    <br/>
                                    <label> Type: </label>
                                    <input id="inputs" ref= "type" type="text" defaultValue={this.state.type} />
                                    <br/>
                                    <br/>
                                    <label> Price: </label>
                                    <input id="inputs" ref= "price" type="number" defaultValue={this.state.price} />
                                    <br/>
                                    <br/>
                                    <label> Image: </label>
                                    <input id="inputs" ref= "image" type="text" defaultValue={this.state.image} />
                                    <br/> <br/>
                                    <label> Capactity: </label>
                                    <input id="inputs" ref= "capactity" type="number" defaultValue={this.state.capactity} />
                                    <br/> <br/>
                                    <label> Location: </label>
                                    <input id="inputs" ref= "location" type="text" defaultValue={this.state.image} />
                                    <br/> <br/>
                                    <label> Website: </label>
                                    <input id="inputs" ref= "website" type="text" defaultValue={this.state.website} />
                                    <br/> <br/>
                                    <label> Description: </label>
                                    <textarea id="areainputs" ref= "description" type="text" defaultValue= {this.state.description} />
                                </div>
                            </div>
                        </div>
                </form>
